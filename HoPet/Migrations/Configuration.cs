namespace HoPet.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<HoPet.Models.ProjectDBContext>
    {
        ...
        protected override void Seed(HoPet.Models.ProjectDBContext context)
        {
            ...
            // pet
            context.Pets.Add(new Pet() { Id = 1, AdoptionDate = new System.DateTime(2019, 7, 17), AnimalType = AnimalType.DOG, Name = "Shuki", Description = "black dog", IsAdopted = false, Birthdate = new System.DateTime(2017, 16, 22) });
            context.Pets.Add(new Pet() { Id = 2, AdoptionDate = new System.DateTime(2018, 7, 17), AnimalType = AnimalType.FISH, Name = "Gutte", Description = "black fish", IsAdopted = false, Birthdate = new System.DateTime(2007, 03, 17) });
            context.Pets.Add(new Pet() { Id = 3, AdoptionDate = new System.DateTime(2018, 9, 1), AnimalType = AnimalType.HAMSTER, Name = "Jasper", Description = "black hamster", IsAdopted = true, Birthdate = new System.DateTime(2017, 07, 18) });
            context.Pets.Add(new Pet() { Id = 4, AdoptionDate = new System.DateTime(2017, 07, 17), AnimalType = AnimalType.RAT, Name = "Pinky", Description = "black rat", IsAdopted = false, Birthdate = new System.DateTime(2016, 07, 17) });
            context.Pets.Add(new Pet() { Id = 5, AdoptionDate = new System.DateTime(2017, 02, 17), AnimalType = AnimalType.DOG, Name = "Kamila", Description = "white dog", IsAdopted = true, Birthdate = new System.DateTime(2018, 09, 04) });
